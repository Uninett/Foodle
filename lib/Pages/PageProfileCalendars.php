...
class Pages_PageProfileCalendars extends Pages_Page {
	...
	function __construct($config, $parameters) {
		...
		$this->template = new SimpleSAML_XHTML_Template($this->config, 'profile-calendars.php', 'foodle_foodle');
		$this->setLocale();
...
// 			'fr' => 'fr_FR',
	...
	function show() {
		...
		$this->template->data['bread'] = array(
			...
			array('href' => '/' . $this->config->getValue('baseurlpath') . 'profile', 'title' => $this->user->username), 
			array('title' => 'Calendar setup'), 
		);
