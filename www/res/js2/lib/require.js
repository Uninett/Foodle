...
requirejs.config({
    ...
    "paths": {
        ...
        "typeahead": "/res/js2/lib/bootstrap3-typeahead",

        "moment": "/res/js2/lib/moment",
        "moment-timezone": "/res/js2/lib/moment-timezone",
        "moment-timezone-data": "/res/js2/lib/moment-timezone-data"
    },
    shim: {
        'bootstrap/bootstrap': { deps: ['jquery'] },
        'bootstrap-datepicker': { deps: ['jquery', 'bootstrap/bootstrap'] },
        'typeahead': { deps: ['jquery', 'bootstrap/bootstrap'], exports: 'jQuery' },
